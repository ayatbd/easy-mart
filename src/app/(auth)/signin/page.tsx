          ...
          <div className="w-full max-w-100 flex flex-col">
            ...
            <form className="flex flex-col gap-10">
              ...
              <div className="flex flex-col gap-4 mt-2">
                ...
                <button
                  type="button"
                  className="w-full border border-gray-400 bg-white text-black py-2 rounded-sm font-medium hover:bg-gray-50 transition-colors flex items-center justify-center gap-3"
                >
                  <svg
                    width="24"
                    height="24"
